...
const videoSD = 'http://cdn.einser.info/videos/mono/mono-sd.mp4',
      videoHD = 'http://cdn.einser.info/videos/mono/mono-hd.mp4';
...
$(document).ready(() => {
    ...
    if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        ...
        const $introVideo = $('<video autoplay><source src="http://cdn.einser.info/videos/mono/mono-preview.mp4" type="video/mp4"></video>');
